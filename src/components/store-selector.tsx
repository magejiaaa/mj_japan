  ...
  return (
    <Select value={value} onValueChange={onChange}>
      ...
      <SelectContent>
        ...
        <SelectItem value="classicalElf">Classical Elf (未滿¥3980｜590日幣)</SelectItem>
        ...
        <SelectItem value="lizlisa">Liz Lisa (未滿¥5500｜550日幣)</SelectItem>
        <SelectItem value="majesticlegon">majesticlegon (未滿¥7500｜550日幣)</SelectItem>
        <SelectItem value="mycolor">MyColor (未滿¥10000｜660日幣)</SelectItem>
        <SelectItem value="pium">pium (800日幣)</SelectItem>
        <SelectItem value="palcloset">PAL CLOSET (未滿¥5000｜550日幣)</SelectItem>
